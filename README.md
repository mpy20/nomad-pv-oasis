![docker image](https://github.com/mpy20/nomad-pv-oasis/actions/workflows/docker-publish.yml/badge.svg)


# mpy20's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of mpy20.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/mpy20/nomad-pv-oasis.git
    cd nomad-pv-oasis
    ```
    ...
    ```sh
    curl-L -o nomad-pv-oasis.zip "https://github.com/mpy20/nomad-pv-oasis/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/mpy20/nomad-pv-oasis:main` for the services
...
```sh
docker pull ghcr.io/mpy20/nomad-pv-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/mpy20/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/mpy20/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/mpy20/nomad-pv-oasis/manifests/main": unauthorized`
